...
func (q *Queries) GetPlayerSeasonsByPlayerID(ctx context.Context, playerID int) ([]domain.PlayerSeason, error) {
	return q.playerSeasons.FindByPlayerID(ctx, playerID)
}
