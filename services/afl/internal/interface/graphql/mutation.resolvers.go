...
// RecalculateAFLLadder is the resolver for the recalculateAFLLadder field.
func (r *mutationResolver) RecalculateAFLLadder(ctx context.Context, seasonID string) (bool, error) {
