...
func (q *Queries) GetRoundByAFLRoundID(ctx context.Context, aflRoundID int) (domain.Round, error) {
	return q.rounds.FindByAFLRoundID(ctx, aflRoundID)
}
...
func (q *Queries) GetClubSeasonsByClub(ctx context.Context, clubID int) ([]domain.ClubSeason, error) {
	return q.clubSeasons.FindByClubID(ctx, clubID)
}
